                            ...
                            <div class="w-100">
                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="my-auto">
                                        ...
                                        <div>
                                            <h5 class="text-primary">Sejam bem vindos!</h5>
                                        ...
                                        <div class="mt-4">
                                            <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input name="email" type="email"
                                                           ...
                                                           value="{{ old('email') }}"
                                                           id="username"
                                                           placeholder="Insira o Email" autocomplete="email" autofocus>
                                                    @error('email')
                                                    ...
                                                    <div class="float-end">
                                                        @if (Route::has('password.request'))
                                                            <a href="{{ route('password.request') }}"
                                                               class="text-muted">Esqueceu a senha?</a>
                                                        @endif
                                                    </div>
                                            ...
                                            <div class="mt-5 text-center">
                                                <p>Não tem uma conta? <a href="{{ url('register') }}"
                                                                              class="fw-medium text-primary">Cadastre-se agora </a></p>
                                            </div>
                                        </div>
                                    </div>
